...
module.exports = async function(req, res) {
  ...
  try {
    ...
    // 3) [제거됨 2026-08-17] pending → completed 자동 승격 금지.
    //    pending 은 결제창만 열고 승인(tid) 없이 나간 기록일 수 있음 — 자동 승격하면
    //    결제 없이 유료 플랜이 활성화됨 (실사례 발생). 승인 완료는 innopay-confirm 만 기록한다.
    //    콜백 유실 케이스는 이노페이 대시보드 대조 후 관리자(admin-force-activate)가 수동 처리.
