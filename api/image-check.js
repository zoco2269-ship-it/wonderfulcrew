...
- 표정: 승무원 지원 사진은 반드시 "치아가 보이도록 활짝 웃는" 밝은 미소여야 합니다. 사진 속 미소가 약하거나 입을 다물고 있으면, "치아가 보이게 환하게 웃는 사진으로 다시 찍으세요"라고 꼭 조언하세요. 이미 잘 웃고 있으면 그 점을 칭찬하고 유지하라고 하세요. 이 항목은 어떤 사진이든 반드시 언급합니다.
- 밝고 자연스러운 인상, 단정한 헤어(이마·얼굴선이 깔끔하게 보이게), 깔끔한 정장, 바른 자세, 밝은 조명도 함께 점검하세요.
